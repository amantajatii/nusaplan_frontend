...
export default function ChatHeader() {
  return (
    <header className="pointer-events-none fixed left-0 right-0 top-3 z-50 flex justify-center px-4">
      <div className="pointer-events-auto flex h-[63px] w-full max-w-[672px] items-center gap-2 rounded-full bg-white/75 px-3 shadow-[0px_14px_40px_0px_rgba(20,30,40,0.25)] ring-1 ring-inset ring-black/[0.05]">
        {/* Back */}
        <button
          type="button"
          aria-label="Kembali"
        ...
        <div className="ml-1 flex min-w-0 flex-1 flex-col">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <p className="font-display text-[11.5px] font-medium leading-[17px] text-[#5B6470]">
